...
class GameIniTab(ttk.Frame):
    def __init__(self, parent, theme_var):
        super().__init__(parent)
        self.theme_var = theme_var

        ttk.Label(self, text="Open Game.ini Files").pack(pady=(8, 4))
        ...
        # Data
        # items: [(server, file_path), ...] only where file exists
        self.items = []
        # vars: server -> tk.BooleanVar for checkbox
        self.vars = {}
    ...
    def populate(self):
        ...
        # Build checkboxes (server name only)
    ...
    def update_theme(self):
        """Update theme for the game ini tab"""
